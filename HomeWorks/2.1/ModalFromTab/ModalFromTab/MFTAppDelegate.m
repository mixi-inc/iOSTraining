...
{
    if( [viewController.nibName isEqual: @"MFTSecondViewController"]) {
        MFTModalViewController *modal = [[MFTModalViewController alloc] init];
        [_tabBarController presentViewController:modal animated:YES completion:nil];
        return NO;
    }
    return YES;
}
